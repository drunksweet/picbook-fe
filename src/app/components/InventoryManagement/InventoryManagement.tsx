...
import { Button, Card, Form, Input, Select, Table, DatePicker, Space, Pagination } from 'antd';
import { SearchOutlined, RedoOutlined, PlusOutlined, UploadOutlined, DownloadOutlined, PrinterOutlined } from '@ant-design/icons';
    ...
    <div className="inventory-container" style={{ padding: 20 }}>
      <Card title="信息检索" bordered={false}>
        <Form form={form} layout="inline">
          ...
          <Form.Item>
            ...
            <Button type="primary" icon={<SearchOutlined />} style={{ marginLeft: 8 }}>搜索</Button>
          </Form.Item>
        </Form>
      </Card>
      ...
      <div style={{ marginTop: 20 }}>
        <Space style={{ marginBottom: 16 }}>
          <Button type="primary" icon={<PlusOutlined />}>新增库存记录</Button>
